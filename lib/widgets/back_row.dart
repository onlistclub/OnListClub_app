...
class BackRow extends StatelessWidget {
  ...
  /// Il testo è 32: la freccia a 34 lo pareggia otticamente (l'SVG ha il
  /// tratto che tocca i bordi del viewBox, quindi rende meno di 34 pieni).
  static const double _arrowSize = 34;

  /// Spazio fra freccia e testo.
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Padding(
        padding: padding ??
            EdgeInsets.fromLTRB(R.sp(12), R.sp(12), R.sp(12), R.sp(8)),
        child: Row(
